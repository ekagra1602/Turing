(
  ...
  function isInteractiveElement(element) {
    ...
    const isCookieBanner =
      String(element.id || '').toLowerCase().includes('cookie') ||
      String(element.id || '').toLowerCase().includes('consent') ||
      String(element.id || '').toLowerCase().includes('notice') ||
      (element.classList && (
      ...
      (element.tagName.toLowerCase() === 'div' && (
        String(element.id || '').includes('onetrust') ||
        (element.classList && (
      ...
      if (nodeData.isVisible) {
        ...
        if (nodeData.isTopElement) {
          ...
          if (nodeData.isInteractive) {
            ...
            // Ensure attributes are extracted for any element that gets a highlight index
            // This is especially important for images that become interactive but weren't caught by isInteractiveCandidate
